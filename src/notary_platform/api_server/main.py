...
from notary_platform.api_server.routers import candidates, certificates, dep_ingress, discovery, discovery_context, incidents, ingestion, platform, release_gate, setup, source_profiling, sweep, verification, viz
...
app.include_router(dep_ingress.router, prefix="/v1")
